...
const BottomFooter = () => {
  return (
    <div className="bg-slate-50">
      <div className="max-w-[1440px] pt-5 m-auto text-center">
        ...
        <div className="grid place-items-center md:place-items-start grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 px-5 py-10">
          {bottomFooterItems.map((item, index) => (
            <div
              key={index}
              className="grid grid-cols-[80px_200px] md:grid-cols-[80px_1fr] items-center gap-5 rounded-xl p-5 bg-gradient-to-t from-oceanBlue/20 to-white/20 border text-center md:w-full shadow-inner"
            >
